...
const checkWinner = (dolphinsAvg, koalasAvg) => {
  if (dolphinsAvg >= koalasAvg * 2) {
    return `The winner are Dolphins with an average score of (${dolphinsAvg} vs. ${koalasAvg})`;
  } else if (koalasAvg >= dolphinsAvg * 2) {
    return `The winner are Koalas with an average score of (${koalasAvg} vs. ${dolphinsAvg})`;
  } else {
