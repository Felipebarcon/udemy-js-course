...
4. During the game,BayernMunich(team1) used 3 substitute players. So create a new array ('players1Final')
...
const printGoals = function (...playersNames) {
  console.log(
    `${playersNames.length} goals were scored by ${playersNames.join(', ')}`
  );
};
