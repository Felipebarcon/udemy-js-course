...
1. Create a method called 'registerNewAnswer' on the 'poll' object. The method does 2 things:
  ...
  of the array by 1. Make sure to check if the input is a number and if the number makes sense (e.g answer 52 wouldn't make sense, right?)
...
const poll = {
  ...
  registerNewAnswer() {
    ...
    // Register the answer with short circuiting
    typeof input === 'number' &&
